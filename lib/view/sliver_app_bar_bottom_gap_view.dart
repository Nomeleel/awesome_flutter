// TODO(Nomeleel): sliver bottom gap
...
class SliverAppBarBottomGapView extends StatelessWidget {
  const SliverAppBarBottomGapView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = ScrollController();
    // TODO: sliver paint issue?
    return Scaffold(
      body: Container(
          color: Colors.black,
          child: Column(
        ...
        CustomScrollView(
          ...
          slivers: [
            ...
            SliverToBoxAdapter2(child: _container()),
            SliverToBoxAdapter2(child: _container()),
            SliverToBoxAdapter2(child: _container()),
            // SliverToBoxAdapter(
            //   child: Container(
            ...
            ColorfulListView().buildSliver(context),
          ],
        ),*/
          ),
    );
...
class SliverToBoxAdapter2 extends SingleChildRenderObjectWidget {
  ...
  @override
  RenderSliverToBoxAdapter2 createRenderObject(BuildContext context) => RenderSliverToBoxAdapter2();
}

class RenderSliverToBoxAdapter2 extends RenderSliverSingleBoxAdapter {
  /// Creates a [RenderSliver] that wraps a [RenderBox].
  RenderSliverToBoxAdapter2({
    RenderBox? child,
  }) : super(child: child);
  ...
  void paint(PaintingContext context, Offset offset) {
    if (child != null && geometry!.visible) {
      ...
      print('------------offset: $offset');
      print('------------paintOffset: ${childParentData.paintOffset}');
      final resetOffset = Offset(offset.dx.ceilToDouble(), offset.dy.ceilToDouble());
      context.paintChild(child!, resetOffset + childParentData.paintOffset);
    }
  }
}
...
class SliverAppBar2 extends StatefulWidget {
  ...
  @override
  State<SliverAppBar2> createState() => _SliverAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverAppBarState extends State<SliverAppBar2> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SliverAppBar2 oldWidget) {
...
class _AppBarTitleBox extends SingleChildRenderObjectWidget {
  const _AppBarTitleBox({required Widget child}) : super(child: child);

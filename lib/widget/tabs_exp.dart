...
/// This sample shows the implementation of [TabBarExp] and [TabBarView] using a [DefaultTabController].
...
/// to control the behavior of the [TabBarExp] and [TabBarView]. This can be used instead of
...
///  * [TabBarExp], which is used to display the [Tab] that corresponds to each page of the [TabBarView].

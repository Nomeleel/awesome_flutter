...
class _ScrollViewJumpTopState extends State<ScrollViewJumpTop> with TickerProviderStateMixin {
  ...
  ValueNotifier<bool> _isShowJumpTop;
  AnimationController _jumpTopAnimationController;

  @override
  void initState() {
    super.initState();

    _isShowJumpTop = ValueNotifier<bool>(false);
    _jumpTopAnimationController = AnimationController(
      vsync: this,
  ...
  Widget jumpTopWidget() {
    return GestureDetector(
      onTap: jumpTop,
      child: widget.jumpTopBuilder(context),
    );
  }
